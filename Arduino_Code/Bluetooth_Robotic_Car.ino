/*
Project: Bluetooth Robotic Car
Developer: Shivansh Ponnala

Description:
Arduino-based Bluetooth-controlled robotic car using
HC-05 Bluetooth module and motor driver.

Note:
This project was built using an open-source Arduino
Bluetooth car code as the base implementation.
The code was studied, tested, and modified during
